...
namespace PongGame
{
    class MultiScore : MainMenuScene
    {

        public MultiScore(SceneManager sceneManager) : base(sceneManager)
        {
        ...
        public new void Render(FrameEventArgs e)
        {
            ...
            GUI.Label(new Rectangle(0, (int)(cc / 2f), (int)aa, (int)(cc * 15f)), "7. SinglePlayer Hightscore", (int)cc, StringAlignment.Center);



            // Multi
            float rr = sceneManager.Width, tt = sceneManager.Height / 2, yy = Math.Min(rr, tt) / 10f;
            GUI.Label(new Rectangle(0, (int)(yy / 2f), (int)rr, (int)(yy * 21f)), "8. Multiplayer Hightscore ", (int)yy, StringAlignment.Center);
